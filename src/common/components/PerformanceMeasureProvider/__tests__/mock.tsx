...
it('fake test to be able to export these mocks into separate files', () => {
...
const entries = [
  ...
  { name: 'largest-contentful-paint', startTime: 1, renderTime: 2 },
];
...
export class MockPerformanceObserver {
  ...
  constructor(cb: any) {
    ...
    (this as any).observe = (_options: Observe) => {
