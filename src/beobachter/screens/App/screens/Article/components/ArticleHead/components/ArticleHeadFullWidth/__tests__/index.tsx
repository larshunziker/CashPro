...
describe('[Component] Article Head Full Width', () => {
  it('Should render article head correctly', () => {
    ...
    expect(queryByTestId('article-head-full-width-wrapper')).not.toBeNull();
    expect(queryByTestId('article-head-full-width-sponsor')).not.toBeNull();
    expect(queryByTestId('article-head-full-width-hero')).not.toBeNull();
  });
  ...
  it('Should not render sponsor section if no sponsor available', () => {
    ...
    expect(queryByTestId('article-head-full-width-wrapper')).not.toBeNull();
    expect(queryByTestId('article-head-full-width-sponsor')).toBeNull();
  });
  ...
  it('Should not render article hero if there is no heroImageBody', () => {
    ...
    expect(queryByTestId('article-head-full-width-wrapper')).not.toBeNull();
    expect(queryByTestId('article-head-full-width-hero')).toBeNull();
  });
});
