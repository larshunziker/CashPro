...
describe('[Component] Beobachter VideoPlayer', () => {
  ...
  it('Should render nothing when no supported player id exists', () => {
    delete initialProps.video.jwPlayerId;
  ...
  it('Should include the Beobachter JW SEO embedUrl in JSON-LD', () => {
    ...
    expect(createSSRHelmetSpy).toHaveBeenCalledWith(
      ...
      expect.any(String),
      expect.any(String),
      'https://cdn.jwplayer.com/players/9Xw0ABCD-xhoEGaS8.html',
    );
  });
});
