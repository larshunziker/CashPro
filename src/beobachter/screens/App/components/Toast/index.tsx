...
): void => displayToast(message, link, toastId, TOAST_TYPE_ERROR);
...
export const displaySuccessToast = (
  ...
  toastId = null,
  /* @ts-ignore TODO: TS2345 ->  Argument of type 'null' is not assignable to parameter of type 'ToastLink'. */
): void => displayToast(message, link, toastId, TOAST_TYPE_SUCCESS);
...
export const displayWarningToast = (
  ...
  toastId = null,
  /* @ts-ignore TODO: TS2345 ->  Argument of type 'null' is not assignable to parameter of type 'ToastLink'. */
): void => displayToast(message, link, toastId, TOAST_TYPE_WARNING);
