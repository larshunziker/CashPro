  ...
  <head>
    ...
    <style type="text/css">
      @font-face {
        ...
        font-weight: 200;
        src: url(/static/media/SpeziaWeb-Regular.1a4672db.woff2);
      }
      ...
      @font-face {
        ...
        font-display: fallback;
        font-weight: 700;
        src: url(/static/media/SpeziaWeb-Bold.1770f674.woff2);
      }
      ...
      .title {
        color: #df0000;
        font-family: Spezia, Helvetica, Arial, Verdana, sans-serif;
        font-size: 32px;
        font-weight: bold;
        line-height: 40px;
        margin-left: 16px;
    ...
    <link
      rel="icon"
      type="image/x-icon"
      href="https://www.beobachter.ch/static/media/a03b96eaebc35622734b37733b17b8af.ico"
    />
  </head>
  <body>
    <div class="wrapper">
        ...
        <div class="headerWrapper">
          <div class="iconWrapper">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><style>
              ...
              <g class="beo-500-animation">
                <ellipse rx="35" ry="35" stroke="#edece8" fill="#edece8" stroke-miterlimit="10" stroke-linejoin="round" stroke-width="2" stroke-dasharray="220 220" stroke-dashoffset="220" fill-opacity="0" fill-rule="evenodd" transform="translate(36,36)" style="animation: 1s linear both a0_so, 1s linear both a0_fo, 1s linear both a0_da, 1s linear both a0_do;"/><g transform="translate(16.2,-936.9)"><path class="st0" d="M1.6 960c-1.2 3.5-0.5 7.6 2.3 10.4c2.8 2.8 6.9 3.6 10.4 2.3l18.5 18.5c1.7 1.7 4.4 1.7 6 0c1.6-1.7 1.7-4.4 0-6l-18.5-18.5c1.2-3.5 .5-7.6-2.3-10.4c-2.8-2.8-6.9-3.6-10.4-2.3l4 4c1.7 1.7 1.7 4.4 0 6c-1.7 1.7-4.4 1.7-6 0l-4-4Z" stroke-width="2" stroke-linejoin="round" stroke="#3e3e3e" stroke-miterlimit="10" fill="#fff" fill-opacity="0" stroke-dashoffset="135" stroke-dasharray="135 135" stroke-linecap="round" transform="translate(-0.7,0)" style="animation: 1s linear both a1_fo, 1s linear both a1_do;"/></g>
              </g>
            </svg>
          </div>

          <div class="title">
            Hoppla – beobachter.ch ist gerade nicht erreichbar.
          </div>
        </div>

        <div class="description">
          Es ist ein technischer Fehler aufgetreten, wir bitten Sie um Geduld.
