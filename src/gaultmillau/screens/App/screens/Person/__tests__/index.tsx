...
import { DEFAULT_PERSON_HOME_DE } from '../../../constants';
  ...
  initialState = {
    route: {
      ...
      locationBeforeTransitions: {
        ...
        pathname: `/${DEFAULT_PERSON_HOME_DE}`,
      },
    },
    loading: loading,
  };
...
describe('[Screen] Persons', () => {
  test('should render webpage schema on the Persons page', async () => {
