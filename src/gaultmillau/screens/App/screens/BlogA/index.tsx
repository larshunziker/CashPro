...
const BlogA: ComponentType<BlogAPropsInner> = ({ data, language, page }) => {
  if (
    !data ||
    typeof data !== 'object' ||
  ...
  return (
    <div className={`zueri-isst-overview ${styles.Wrapper}`}>
      <EditButtons
            ...
            <div className={styles.Header}>
              <h1
                className={classNames(styles.HeaderTitle, {
                  [styles.HeaderTitleFr]: language === 'fr',
                })}
              >
              ...
              <div className={styles.LeadBoxWrapper}>
                ...
                >
                  <span className={styles.LeadTitle}>
                    {(blogPage.teaserImage &&
                      blogPage.teaserImage.image &&
                      blogPage.teaserImage.image.file &&
