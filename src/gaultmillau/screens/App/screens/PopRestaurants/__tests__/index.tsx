...
import { URL_DE_POP_RESTAURANTS } from '../../../constants';
  ...
  initialState = {
    route: {
      ...
      locationBeforeTransitions: {
        ...
        pathname: `/${URL_DE_POP_RESTAURANTS}`,
      },
    },
    loading: loading,
  };
...
describe('[Screen] PopRestaurants', () => {
  test('should render webpage schema on the pop restaurant page', async () => {
