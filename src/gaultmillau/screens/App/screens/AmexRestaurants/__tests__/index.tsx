...
import { URL_DE_AMEX_RESTAURANTS } from '../../../constants';
  ...
  initialState = {
    route: {
      ...
      locationBeforeTransitions: {
        ...
        pathname: `/${URL_DE_AMEX_RESTAURANTS}`,
      },
    },
    loading: loading,
  };
...
describe('[Screen] AmexRestaurants', () => {
  test('should render webpage schema on the americanexpress restaurant page', async () => {
