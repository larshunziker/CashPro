...
import { ARTICLE_RECOMMENDATION_TITLE } from '../../../screens/ArticlePage/constants';
...
describe('[Components] Recommendations', () => {
  ...
  test('Should render recommendations block', () => {
    const { queryByTestId } = render(
      <ReduxProvider state={routeInitialState}>
        ...
        <Component items={items} teaserLayout={TEASER_LAYOUT_RECOMMENDATIONS} />
      </ReduxProvider>,
    );
  ...
  test('Should render recommendations block with 6 recos', () => {
    const title = 'my custom title';
