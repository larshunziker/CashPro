...
const AuthorPage = authorFactory({
  ...
  /* @ts-ignore TODO: TS2322 ->  Type 'NamedExoticComponent<TeaserProps>' is not assignable to type 'TeaserComponent'. */
  Teaser,
  ...
  AuthorDetails,
  ExpansionPanel,
  additionalBreadcrumbText: ' - Mitglied der Cash-Redaktion',
  atPublisherSinceTitle: 'Arbeitet für Cash seit:',
  styles: {
    HeaderWrapper: styles.HeaderWrapper,
    BreadcrumbsWrapper: styles.BreadcrumbsWrapper,
    Description: styles.Description,
    ResultsWrapper: styles.ResultsWrapper,
    AuthorPage: styles.AuthorPage,
...
export default compose<any, any, any>(
  ...
  withHelmet({
    ...
    /* @ts-ignore TODO: TS7031 ->  Binding element 'author' implicitly has an 'any' type. */
    getFallbackTitle: ({ author }) => `${author.name} | cash`,
