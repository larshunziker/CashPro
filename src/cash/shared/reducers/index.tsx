...
import autoUpdateReducer, { autoUpdateInitialState } from './autoUpdate';
import listIdsReducer, { listIdsInitialState } from './listIds';
...
export const initialStates = {
  ...
  autoupdate: autoUpdateInitialState,
  listIds: listIdsInitialState,
