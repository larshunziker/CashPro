  ...
  function getBrandingDayCss({
    ...
    const expandTopClickWrapper = () => {
      ...
      if (paddingTop > 0) {
        ...
        const innerHeader = document.getElementById('header-inner-wrapper');
        /* @ts-ignore TODO: TS2531 ->  Object is possibly 'null'. */
        innerHeader.style.top = `${paddingTop}px`;
        addEventListener('scroll', () => {
          if (window.scrollY > paddingTop) {
            /* @ts-ignore TODO: TS2531 ->  Object is possibly 'null'. */
            innerHeader.style.top = '0';
          } else {
            /* @ts-ignore TODO: TS2531 ->  Object is possibly 'null'. */
            innerHeader.style.top = `${paddingTop - window.scrollY}px`;
          }
        });
      } else {
        /* @ts-ignore TODO: TS2531 ->  Object is possibly 'null'. */
    ...
    return {
      ...
      largeImageCss,
      smallImageCss,
      expandTopClickWrapper: expandTopClickWrapper,
    };
  }
