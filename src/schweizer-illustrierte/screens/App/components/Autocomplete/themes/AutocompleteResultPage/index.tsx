...
/* @ts-ignore TODO: TS7016 ->  Could not find a declaration file for module '../../queries'. '/Users/bhs/code/work/rasch-stack/src/schweizer-illustrie */
import { GET_AUTOCOMPLETE } from '../../queries';
import initialStyles from '../../styles.legacy.css';
...
const AutocompleteComponent = autocompleteFactory({
  ...
  styles: {
    ...
    Link: initialStyles.Link,
    LinkWrapper: initialStyles.LinkWrapper,
    IconStyle: initialStyles.IconStyle,
  },
});
