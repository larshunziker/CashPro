...
import { ToastContentFactoryOptionsStyles } from '../../../../../../../common/components/ToastContent/typings';
...
const getStylesByProps = (type: string): ToastContentFactoryOptionsStyles => ({
