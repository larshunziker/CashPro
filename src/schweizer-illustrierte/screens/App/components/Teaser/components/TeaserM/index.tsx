...
type TeaserMPropsInner = TeaserFactoryProps & {
  activeMainChannel: ActiveMainChannel;
};

/* @ts-ignore TODO: TS2322 ->  Type '(props */
const getStylesByProps: GetTeaserFactoryStylesByProps<TeaserMPropsInner> = (
  props,
) => {
...
const getIconByProps: GetElementByProps<TeaserMPropsInner> = ({
  hasVideo,
  __typename,
  activeMainChannel,
}) => {
...
}) as ComponentType<TeaserMPropsInner>;
...
export default connect(mapStateToProps)(memo(TeaserM));
