...
declare const styles: {
  ...
  readonly "Item11": string;
  readonly "Item12": string;
  readonly "Item13": string;
  readonly "Item14": string;
  readonly "Item15": string;
  readonly "Item16": string;
  readonly "Item17": string;
  readonly "Item18": string;
  readonly "Item19": string;
  readonly "Item20": string;
  readonly "Item21": string;
  readonly "Item22": string;
  readonly "Item23": string;
  readonly "Item24": string;
  readonly "Item25": string;
  readonly "Item26": string;
  readonly "Item27": string;
};
export = styles;
