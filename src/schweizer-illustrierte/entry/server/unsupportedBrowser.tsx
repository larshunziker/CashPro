...
<html lang="de-CH">
    ...
    <style type="text/css">
      @font-face {
        ...
        src: local("LeJeuneDeck-Semibold-Web"),
          url(https://www.schweizer-illustrierte.ch/static/media/subset-LeJeuneDeck-Semibold-Web.dff281b3.woff);
      }
      ...
      @font-face {
        ...
        src: local("PFBagueSansPro-Light"),
          url(https://www.schweizer-illustrierte.ch/static/media/subset-PFBagueSansPro-Light.a8957060.woff);
      }
      ...
      @font-face {
        ...
        src: local("PFBagueSansPro-Bold"),
          url(https://www.schweizer-illustrierte.ch/static/media/subset-PFBagueSansPro-Bold.f84ff746.woff);
      }
      ...
      .link {
        font-family: PFBagueSansProBold, Arial, Helvetica, sans-serif;
        font-size: 16px;
        font-weight: 900;
        text-align: center;
  ...
  <body>
        ...
        <div class="headerWrapper">
          <div class="iconWrapper">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
              <g>
                <circle fill="#D8D8D8" stroke="#D8D8D8" stroke-miterlimit="10" cx="36" cy="36" r="35.5"/><path fill="#FFF" stroke="#4A4A4A" stroke-width="2" stroke-linejoin="round" stroke-miterlimit="10" d="M47.28 54.91H22.17a.76.76 0 01-.76-.76V23.42a1 1 0 01.3-.71l5.39-5.32c.19-.18.44-.29.7-.29h19.48c.42 0 .76.34.76.76v36.3c0 .41-.34.75-.76.75z"/><path fill="none" stroke="#4A4A4A" stroke-width="2" stroke-linejoin="round" stroke-miterlimit="10" d="M21.57 23.63h5.54c.55 0 1-.45 1-1v-5.54"/><path fill="none" stroke="#4A4A4A" stroke-width="2" stroke-miterlimit="10" d="M35 30v9"/><g fill="#4A4A4A"><circle cx="35" cy="42" r="1"/><path d="M35 41.5c.28 0 .5.22.5.5s-.22.5-.5.5-.5-.22-.5-.5.22-.5.5-.5m0-1c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z"/></g>
              </g>
            </svg>  
          </div>
    ...
    <script type="text/javascript">
      (function(a,b,c,d){
      a='https://tags.tiqcdn.com/utag/rasch/schweizer-illustrierte.ch/prod/utag.js';
